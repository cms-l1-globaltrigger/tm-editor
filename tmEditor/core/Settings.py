...
CutSpecs = CutSpecificationPool(
    ...
    CutSpecification(
        ...
        functions=[tmGrammar.comb, tmGrammar.dist, tmGrammar.mass, tmGrammar.mass_inv, tmGrammar.mass_inv_upt, tmGrammar.mass_inv_3_obj, tmGrammar.mass_inv_div_dr],
    ...
    CutSpecification(
        ...
        functions=[tmGrammar.mass, tmGrammar.mass_inv,  tmGrammar.mass_inv_upt, tmGrammar.mass_inv_3_obj, tmGrammar.mass_inv_div_dr, tmGrammar.mass_inv_orm, tmGrammar.mass_trv],
        range_precision=1,
        range_step=0.2,
        range_unit="GeV",
        title="Invariant mass or Transverse mass or Invariant mass divided by deltaR or Invariant mass with 3 objects or Invariant mass with upt",
